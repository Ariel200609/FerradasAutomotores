  ...
  >
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-2 py-16">
        <h2 className="text-4xl md:text-3xl font-bold mb-6 text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-black/80 rounded-xl p-8 text-center hover:bg-gray-800/90 transition-all duration-300 border border-gray-800">
          ...
          <h3 className="text-2xl font-bold mb-4 text-white transition-colors duration-300 hover:text-red-600 cursor-pointer drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Vehículos 0 KM</h3>
        ...
        <div className="bg-black/80 rounded-xl p-8 text-center hover:bg-gray-800/90 transition-all duration-300 border border-gray-800">
          ...
          <h3 className="text-2xl font-bold mb-4 text-white transition-colors duration-300 hover:text-red-600 cursor-pointer drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Vehículos Usados</h3>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-black/80 rounded-xl p-8 text-center hover:bg-gray-800/90 transition-all duration-300 border border-gray-800">
          <CheckCircle className="h-16 w-16 text-red-600 mx-auto mb-6" />
          <h3 className="text-2xl font-bold mb-4 text-white transition-colors duration-300 hover:text-red-600 cursor-pointer drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Financiamiento</h3>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-black/80 rounded-xl p-8 text-center hover:bg-gray-800/90 transition-all duration-300 border border-gray-800">
          <CheckCircle className="h-16 w-16 text-red-600 mx-auto mb-6" />
          <h3 className="text-2xl font-bold mb-4 text-white transition-colors duration-300 hover:text-red-600 cursor-pointer drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Asesoramiento</h3>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-black/80 rounded-xl p-8 text-center hover:bg-gray-800/90 transition-all duration-300 border border-gray-800">
          <CheckCircle className="h-16 w-16 text-red-600 mx-auto mb-6" />
          <h3 className="text-2xl font-bold mb-4 text-white transition-colors duration-300 hover:text-red-600 cursor-pointer drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Garantía</h3>
          <p className="text-gray-300 leading-relaxed">
        ...
        <div className="bg-black/80 rounded-xl p-8 text-center hover:bg-gray-800/90 transition-all duration-300 border border-gray-800">
          ...
          <h3 className="text-2xl font-bold mb-4 text-white transition-colors duration-300 hover:text-red-600 cursor-pointer drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Toma de Usado</h3>
          <p className="text-gray-300 leading-relaxed">
    ...
    {/* Media query para mobile: fondo cover y posición top */}
    <style>{`
      @media (max-width: 768px) {
        #services {
          ...
          background-image: url('/FerradasAutomotores/inicioPrincipal4-mobile.jpg') !important;
        }
      }
    `}</style>
  </section>
